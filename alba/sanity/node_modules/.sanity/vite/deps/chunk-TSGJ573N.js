...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-R44UXKZW.js")
});
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  ...
  const $ = (0, import_react_compiler_runtime.c)(74), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$k), isLocked = (_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0, t1;
...
var DocumentPanel = function(props) {
  ...
  bb1: {
    ...
    let t17;
    $[66] !== (permissions == null ? void 0 : permissions.granted) || $[67] !== requiredPermission ? (t17 = !(permissions == null ? void 0 : permissions.granted) && (0, import_jsx_runtime2.jsx)(InsufficientPermissionBanner, { requiredPermission }), $[66] = permissions == null ? void 0 : permissions.granted, $[67] = requiredPermission, $[68] = t17) : t17 = $[68];
...
var UnpublishAction = ({
  ...
  const {
    ...
    type: "dialog",
    onClose: onComplete,
    content: (0, import_jsx_runtime2.jsx)(ConfirmDeleteDialogContainer, { id: (draft == null ? void 0 : draft._id) || id, type, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm })
...
var DocumentPerspectiveList = (0, import_react2.memo)(function() {
  ...
  }, [displayed == null ? void 0 : displayed._id, editState == null ? void 0 : editState.version, params == null ? void 0 : params.historyVersion]), isPublishSelected = (0, import_react2.useMemo)(() => {
    var _a2;
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  const {
    ...
    lastRevisionDocument
  } = useDocumentLastRev(documentId, documentType), getIsDeleted = (0, import_react2.useCallback)((editState) => timelineReady ? !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) && !(editState == null ? void 0 : editState.version) && !isPristine : false, [timelineReady, isPristine]), getComparisonValue = (0, import_react2.useCallback)((editState_0) => changesOpen ? sinceDocument || (editState_0 == null ? void 0 : editState_0.published) : (editState_0 == null ? void 0 : editState_0.published) || null, [changesOpen, sinceDocument]), schemaType = schema.get(documentType), getIsReadOnly = (0, import_react2.useCallback)((editState_1) => {
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-PJRJYKHK.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-IEWBHGJS.js"))
};
...
function DocumentNodePathBreadcrumbs(props) {
  ...
  return (pathTitles == null ? void 0 : pathTitles.length) ? (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: pathTitles.map((t2, i) => (
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-VGP66DUK.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-TSGJ573N.js.map
