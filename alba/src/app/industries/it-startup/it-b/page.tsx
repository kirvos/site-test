...
const caseStudy = {
  ...
  testimonial: {
    quote: "助成金申請で大きな成果を上げることができ、事業拡大の資金調達に成功しました。特に、ALBAさんの戦略的なアプローチにより、複数の助成金を同時に進行できたことが非常に効果的でした。おかげで計画通りの人材採用とDX推進ができ、事業成長が加速しています。",
    author: "佐藤 様"
  },
      ...
      <section className="pt-24 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm text-[var(--text-muted)]">
            ...
            <span>/</span>
            <Link href="/industries" className="hover:text-[var(--primary-color)]">IT・スタートアップ</Link>
            <span>/</span>
