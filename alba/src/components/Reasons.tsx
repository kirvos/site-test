...
export default function Reasons() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-white to-gray-50 relative overflow-hidden scroll-snap-align-start flex items-center justify-center">
      {/* Background pattern */}
