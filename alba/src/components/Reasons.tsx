...
export default function Reasons() {
  ...
  return (
    <section className="h-screen bg-gradient-to-b from-white to-gray-50 relative overflow-hidden flex items-center justify-center" style={{scrollSnapAlign: 'start'}}>
      {/* Background pattern */}
