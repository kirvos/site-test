...
export default function Stats() {
  ...
  return (
    <section className="py-16 min-h-screen bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] relative overflow-hidden scroll-snap-align-start flex items-center">
