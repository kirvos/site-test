export default function SocialProof() {
  ...
  return (
    <section className="h-screen bg-gradient-to-br from-gray-50 to-white relative overflow-hidden flex items-center justify-center" style={{scrollSnapAlign: 'start'}}>
